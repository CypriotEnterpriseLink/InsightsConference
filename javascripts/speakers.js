...
$(window).load(function(){
     ...
     $(".speakers-gallery a.more_info").click(function(event){
		 event.preventDefault();
               var source = $(this).attr("href");
                // $('div#filter_wrapper').slideUp(300, function(){
                         //$('div.speakers-content-container').append('<div class="loading"></div>');
                         // $('html,body').animate({scrollTop: $("#portfolio-wrap").offset().top - 150},'slow', function(){
                               $('html, body').animate({scrollTop: ($('.speakers-content-container').offset().top - 50)},'slow', function(){
                                   $('div.speakers-content-container').load(source, function(){
                                             $('div.loading').remove();
                                             //$('#item_slider').flexslider({ controlNav: true, prevText: "<", nextText: ">" });
                                             
                                             $('div#speakers_item').slideDown(1500, function(){
                                                       ...
                                                       $('#control_buttons a#close').click(function(){
                                                                 $('div#speakers_item').slideUp(1000, function(){
